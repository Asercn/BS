...
INSERT INTO `x_customer` VALUES (165, '213132321132213321', 'test', '男', '15779851162');
INSERT INTO `x_customer` VALUES (166, '123132213123123321', 'w', '男', '32123113201');
INSERT INTO `x_customer` VALUES (167, '231213321231231321', 'test', '其它', '13232132101');
INSERT INTO `x_customer` VALUES (168, '123123321231132321', 'www', '男', '32113213210');
INSERT INTO `x_customer` VALUES (169, '132123123123132231', 'test', '其它', '12312313212');
...
INSERT INTO `x_customer_room` VALUES (116, '2024-01-08', '2024-01-10', 2, 165);
INSERT INTO `x_customer_room` VALUES (117, '2024-01-07', '2024-01-10', 1, 166);
INSERT INTO `x_customer_room` VALUES (118, '2024-01-09', '2024-01-10', 10, 167);
INSERT INTO `x_customer_room` VALUES (119, '2024-01-28', '2024-01-30', 2, 168);
INSERT INTO `x_customer_room` VALUES (120, '2024-01-31', '2024-02-13', 17, 169);
...
-- Records of x_menu
-- ----------------------------
INSERT INTO `x_menu` VALUES (2, 'Layout', '/room', '/room/boroom', 'room', '房间管理', 'tree', 0, 'N', 0, 0);
INSERT INTO `x_menu` VALUES (3, 'room/boroom', 'boroom', '', 'boroom', '开房记录', 'el-icon-s-custom', 2, 'Y', 0, 0);
INSERT INTO `x_menu` VALUES (4, 'room/oroom', 'oroom', '', 'oroom', '订房', 'el-icon-house', 2, 'Y', 0, 0);
INSERT INTO `x_menu` VALUES (5, 'room/roommanagement', 'roommanagement', '', 'roommanagement', '房间设置', 'el-icon-s-home', 2, 'Y', 0, 0);
INSERT INTO `x_menu` VALUES (6, 'Layout', '/system', '/system/user', 'system', '系统管理', 'el-icon-share', 0, 'N', 0, 0);
INSERT INTO `x_menu` VALUES (7, 'system/user', 'user', '', 'user', '用户管理', 'el-icon-user', 6, 'Y', 0, 0);
INSERT INTO `x_menu` VALUES (8, 'system/role', 'role', '', 'role', '角色管理', 'el-icon-s-custom', 6, 'Y', 0, 0);
INSERT INTO `x_menu` VALUES (9, 'Layout', '/systemmonitor', '/systemmonitor/systeminterface', 'systemmonitor', '系统监控', 'el-icon-video-camera-solid', 0, 'N', 0, 0);
INSERT INTO `x_menu` VALUES (10, 'systemmonitor/systeminterface', 'systeminterface', NULL, 'systeminterface', '系统接口', 'el-icon-pie-chart', 9, 'Y', 0, 1);
INSERT INTO `x_menu` VALUES (11, 'systemmonitor/systeminfo', 'systeminfo', NULL, 'systeminfo', '系统信息', 'el-icon-tickets', 9, 'Y', 0, 0);
INSERT INTO `x_menu` VALUES (13, 'system/controlmenu', 'controlmenu', NULL, 'controlmenu', '菜单控制', 'el-icon-s-operation', 6, 'Y', 0, 1);
INSERT INTO `x_menu` VALUES (14, 'room/orderfrom', 'orderfrom', NULL, 'orderfrom', '订单记录', 'el-icon-s-order', 2, 'Y', 0, 0);
INSERT INTO `x_menu` VALUES (28, 'Layout', '/userreservation', '/userreservation/reservation', 'userreservation', '用户订房', 'el-icon-user-solid', 0, 'N', 0, -1);
INSERT INTO `x_menu` VALUES (29, 'userreservation/reservation', 'reservation', NULL, 'reservation', '订房', 'el-icon-user-solid', 28, 'Y', 0, 2);
INSERT INTO `x_menu` VALUES (30, 'userreservation/test', 'test', NULL, 'test', 'test', 'el-icon-warning', 28, 'Y', 0, 1);
INSERT INTO `x_menu` VALUES (38, 'system/noticemanager', 'noticemanager', NULL, 'noticemanager', '公告管理', 'el-icon-s-comment', 6, 'Y', 0, 0);
...
CREATE TABLE `x_notice`  (
  ...
  `hidden` varchar(10) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT '0',
...
-- Records of x_notice
-- ----------------------------
INSERT INTO `x_notice` VALUES (1, 'TEST', '0', '2024-02-02 23:44:53', '这是一个测试公告');
INSERT INTO `x_notice` VALUES (2, 'test2', '0', '2024-02-03 01:35:21', '这个是在页面上操作的');
INSERT INTO `x_notice` VALUES (7, 'as', '0', '2024-02-03 01:45:14', 'fasf');
INSERT INTO `x_notice` VALUES (8, 'asdfa', '0', '2024-02-03 02:23:40', 'fdasdfadf');
INSERT INTO `x_notice` VALUES (9, 'asdfasdfasdf', '0', '2024-02-03 02:23:44', 'asdfasdf');
INSERT INTO `x_notice` VALUES (10, 'asfd', '0', '2024-02-03 02:23:46', 'asdfasfdasdas');
INSERT INTO `x_notice` VALUES (11, 'asdf', '0', '2024-02-03 02:23:48', 'fasdasda');
INSERT INTO `x_notice` VALUES (12, 'asfda', '0', '2024-02-03 02:23:51', 'fasdfasasdsad');
INSERT INTO `x_notice` VALUES (13, 'asdfadf', '0', '2024-02-03 02:23:53', 'adfasfdasfdasdf');
INSERT INTO `x_notice` VALUES (14, NULL, '0', '2024-02-03 02:23:57', NULL);
INSERT INTO `x_notice` VALUES (15, 'asdfasdfas', '0', '2024-02-03 02:24:03', 'fasfasfasfasf');
INSERT INTO `x_notice` VALUES (16, 'asfdfd', '0', '2024-02-03 02:26:25', 'fds');
INSERT INTO `x_notice` VALUES (17, '13212', '0', '2024-02-03 02:30:38', '31231');
INSERT INTO `x_notice` VALUES (18, 'asfasfd', '0', '2024-02-03 02:33:22', 'afsfda');
INSERT INTO `x_notice` VALUES (19, NULL, '1', '2024-02-03 02:36:29', NULL);
INSERT INTO `x_notice` VALUES (20, '1234143', '1', '2024-02-03 02:36:38', '12341243');
INSERT INTO `x_notice` VALUES (21, '124123', '0', '2024-02-03 02:36:55', '414324143');
INSERT INTO `x_notice` VALUES (22, '12421', '1', '2024-02-03 02:37:04', '3412434');
INSERT INTO `x_notice` VALUES (23, '1241243134', '0', '2024-02-03 02:37:13', '412321341');
INSERT INTO `x_notice` VALUES (24, '12432143', '0', '2024-02-03 02:37:24', '14243');
INSERT INTO `x_notice` VALUES (25, '144', '0', '2024-02-03 02:37:31', '144422');
INSERT INTO `x_notice` VALUES (26, '124124', '1', '2024-02-03 02:37:38', '14144');
INSERT INTO `x_notice` VALUES (27, '124234', '0', '2024-02-03 02:38:37', '1324234');
INSERT INTO `x_notice` VALUES (28, '124124', '0', '2024-02-03 02:38:40', '41432');
INSERT INTO `x_notice` VALUES (29, '12431', '0', '2024-02-03 02:38:45', '2423142');
INSERT INTO `x_notice` VALUES (30, 'asdf', '1', '2024-02-03 02:39:51', 'asfd');
INSERT INTO `x_notice` VALUES (31, 'asdfasd', '0', '2024-02-03 02:40:02', 'asfdafsd');
INSERT INTO `x_notice` VALUES (32, 'asdfaf', '1', '2024-02-03 02:41:26', 'dffwfew');
INSERT INTO `x_notice` VALUES (33, 'wfewefw', '1', '2024-02-03 02:41:33', 'effwefw');
INSERT INTO `x_notice` VALUES (34, 'asfafda', '0', '2024-02-03 02:41:38', 'fadfasfasf');
...
INSERT INTO `x_orderfrom` VALUES (8, '2024-01-08 16:18:52', 240.00, '116', NULL);
INSERT INTO `x_orderfrom` VALUES (9, '2024-01-08 16:19:19', 300.00, '117', NULL);
INSERT INTO `x_orderfrom` VALUES (10, '2024-01-08 16:49:58', 100.00, '118', NULL);
INSERT INTO `x_orderfrom` VALUES (11, '2024-01-28 16:27:20', 240.00, '119', NULL);
INSERT INTO `x_orderfrom` VALUES (12, '2024-01-31 18:26:27', 1300.00, '120', NULL);
...
INSERT INTO `x_role` VALUES (4, 'normal', '普通员工(前台)');
...
-- ----------------------------
INSERT INTO `x_role_menu` VALUES (165, 4, 3);
INSERT INTO `x_role_menu` VALUES (166, 4, 4);
INSERT INTO `x_role_menu` VALUES (167, 4, 5);
INSERT INTO `x_role_menu` VALUES (168, 4, 14);
INSERT INTO `x_role_menu` VALUES (169, 4, 11);
INSERT INTO `x_role_menu` VALUES (170, 4, 2);
INSERT INTO `x_role_menu` VALUES (171, 4, 9);
INSERT INTO `x_role_menu` VALUES (232, 3, 29);
INSERT INTO `x_role_menu` VALUES (234, 3, 28);
INSERT INTO `x_role_menu` VALUES (273, 1, 29);
INSERT INTO `x_role_menu` VALUES (274, 1, 2);
INSERT INTO `x_role_menu` VALUES (275, 1, 3);
INSERT INTO `x_role_menu` VALUES (276, 1, 4);
INSERT INTO `x_role_menu` VALUES (277, 1, 5);
INSERT INTO `x_role_menu` VALUES (278, 1, 14);
INSERT INTO `x_role_menu` VALUES (279, 1, 6);
INSERT INTO `x_role_menu` VALUES (280, 1, 7);
INSERT INTO `x_role_menu` VALUES (281, 1, 8);
INSERT INTO `x_role_menu` VALUES (282, 1, 38);
INSERT INTO `x_role_menu` VALUES (283, 1, 13);
INSERT INTO `x_role_menu` VALUES (284, 1, 9);
INSERT INTO `x_role_menu` VALUES (285, 1, 11);
INSERT INTO `x_role_menu` VALUES (286, 1, 10);
INSERT INTO `x_role_menu` VALUES (287, 1, 28);
INSERT INTO `x_role_menu` VALUES (295, 7, 3);
INSERT INTO `x_role_menu` VALUES (296, 7, 5);
INSERT INTO `x_role_menu` VALUES (297, 7, 38);
INSERT INTO `x_role_menu` VALUES (298, 7, 2);
INSERT INTO `x_role_menu` VALUES (299, 7, 6);
...
CREATE TABLE `x_room`  (
  ...
  `room_name` varchar(50) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL,
  `room_price` int(0) NOT NULL,
  `room_type` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
  `room_picture` varchar(255) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NULL DEFAULT NULL,
...
-- Records of x_room
-- ----------------------------
INSERT INTO `x_room` VALUES (1, '001', 100, '单人房', '1706780639856.jpg');
INSERT INTO `x_room` VALUES (2, '002', 120, '双人间', '1706781149139.jpg');
INSERT INTO `x_room` VALUES (3, '003', 50, '麻将房', '1706781191969.jpg');
INSERT INTO `x_room` VALUES (4, '004', 100, '电脑房', '1706781203488.jpg');
INSERT INTO `x_room` VALUES (5, '100', 100, '大床房', '1706783006229.jpg');
INSERT INTO `x_room` VALUES (7, '101', 100, '单人房', '1706782811659.jpg');
INSERT INTO `x_room` VALUES (9, '103', 100, '双人间', '1706783307756.jpg');
INSERT INTO `x_room` VALUES (10, '104', 100, '单人房', '1706783312289.jpg');
INSERT INTO `x_room` VALUES (16, '111', 100, 'test12', '1706783316773.jpg');
INSERT INTO `x_room` VALUES (17, '121', 100, 'test1', '1706783321201.jpeg');
INSERT INTO `x_room` VALUES (18, '009', 120, '总统房', NULL);
INSERT INTO `x_room` VALUES (20, '测试房间', 10086, 'test', NULL);
INSERT INTO `x_room` VALUES (21, '1234', 100, '测试房间', '');
...
CREATE TABLE `x_user`  (
  ...
  `state` char(5) CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci NOT NULL DEFAULT '1',
  PRIMARY KEY (`id`) USING BTREE,
...
INSERT INTO `x_user` VALUES (9, 'test2', '$2a$10$2qskBQPjEfDrLPOW7Tzgp.yBEv1EY96BvrUYz/ToZ5yn3ZOqOVh0O', '123@test.com', '12345678903', NULL, 0, '-1');
...
INSERT INTO `x_user` VALUES (13, 'test4', '$2a$10$JRUHLTZZlU9etGo7M.Al6OvY3lTrSrzUXl44bTfRBq3usRqdAG6xq', '123@qq.com', '12313232101', NULL, 0, '1');
...
INSERT INTO `x_user_role` VALUES (23, 9, 7, 0);
INSERT INTO `x_user_role` VALUES (25, 12, 3, 0);
INSERT INTO `x_user_role` VALUES (26, 13, 7, 0);
